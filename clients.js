...
const kmsClient = kms.localCsfleHelper(); //done

async function main(regularClient, csfleClient) {
  try {
    let dataKey = "HbN3+kboRtuePnZQJoP1nw=="; // change this to the base64 encoded data key generated from make-data-key.js
    if (dataKey === null) {
